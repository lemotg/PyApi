...
class StudentApiTest(unittest.TestCase, GetValue, LogInfo):
    ...
    def test_1(self):
        ...
        r = requests.post(self.url0, json={"name": self.name, "phone": self.phone}, cookies=self.cookie, headers=self.header)
        result = r.json()
    ...
    def test_3(self):
        ...
        r = requests.post(self.url1, json={"studentId": studentid,
                                           "trackBody": {
                                           ...
                                           "studentType": "1"}, cookies=self.cookie)
        result = r.json()
        self.log.debug(result)
